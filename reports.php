           	    ...
           	    <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Receipts details with account names</td>
                            <td><input type="checkbox" name="reports" id="selected_reports" value="1" /></td>
                        ...
                        <tr>
                            ...
                            <td>Receipts grouped by account names</td>
                            <td><input type="checkbox" name="reports" id="selected_reports" value="2" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Receipts summary by account names</td>
                            <td><input type="checkbox" name="reports" id="selected_reports" value="3" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Receipts Summary by each day</td>
                            <td><input type="checkbox" name="reports" id="selected_reports" value="4" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Receipts Summary by Main accounts</td>
                            <td><input type="checkbox" name="reports" id="selected_reports" value="5" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Receipts summary by months</td>
                            <td><input type="checkbox" name="reports" id="selected_reports" value="6" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Receipts summary by main accounts and subaccounts</td>
                            <td><input type="checkbox" name="reports" id="selected_reports" value="7" /></td>
                            <td>
                        ...
                        <tr>
                        	<td>Users activity by selected dates</td>
                            <td>Users activity by selected period</td>
                            <td><input type="checkbox" name="reports" id="selected_reports" value="8" /></td>
                            <td>
								<span id="users_activity_report_loading_msg" style="display:none;"> Wait...</span>
								<a href="javascript:void(0);" style="display:none;" id="users_activity_report_icon" class="glyphicon glyphicon-print" onclick="PrintReports('#users_activity_report')"></a></td>
                        </tr>
                       <?php /*?> <tr>
...
order by for_opt");
            ...
            <div style="width:100%;display:none;" id="users_activity_report">

                <div style="border-bottom:1px solid #333;overflow:auto;">
                    <h3 align="center">Users activity by selected dates</h3>
                    <div style="width:100%;float:left;font-weight:bold;" id="p_r_receipt_no_1">   Date: <?php echo date('d M, Y h:i:sa'); ?></div>
                </div>
                <h3> <center>Period </center></h3>
                <h5 id="report_period"><center><?php echo date('d/m/Y', strtotime($start_date)); ?> - <?php echo date('d-m-Y', strtotime($end_date)); ?> </center></h5>
                <div style="padding-left:20px;width:98%;margin-top:5px;">
                    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
                        <tr align="center">
                           <th>#</th>
                           <th  style="padding:5px;float:left;">User</th>
                           <th  style="padding:5px;">Receipts </th>
                           <th  style="padding:5px;">Vehicles </th>
                           <th  style="padding:5px;">Licence </th>
                           <th  style="padding:5px;">Vehicle Trasnfer </th>
                           <th  style="padding:5px;">Total </th>
                        </tr>
                        <tbody align="center" id="users_activity_report_area">
                        <?php
						$counter = 1; $sum = 0.00;
						//$data = mysqli_query($con,"SELECT * FROM tbl_receipts where date between '".date('Y-m-d', strtotime($start_date))."' and '".date('Y-m-d', strtotime($end_date))."'");
						//while($rec = mysqli_fetch_object($data))
