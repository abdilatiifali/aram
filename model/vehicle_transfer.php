               ...
               <form role="form" class="form-inline mar1">
                    	...
                    	<div class="col">
                        	<form role="form" class="form-horizontal">
                            	<div class="form-group">
                                    ...
                                    <input id="text-middle" type="text" class="form-control" value="<?php echo isset($search_result->birth_day) ? $search_result->birth_day : '' ;?>"/>
                                </div>
                                <div class="form-group">
                ...
                <form role="form" class="form-inline mar1">
                    <div class="form-group onemargin">
                        ...
                        <input id="text-short" type="text" class="form-control" value="<?php echo isset($search_result->plate_no) ? $search_result->plate_no : '';?>"/>
                    </div>
                                                ...
                                                <div style="margin-right:135px" class="col">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <br/>
                                                            <input id="text-short" type="text" name="birth_date" required class="form-control"/>
                                                        </div>
                                                        <div class="form-group">
                ...
                <div id="card-list3" class="tab-pane fade">
                	<div class="search-border2">Search by date</div>
                    	<form role="form" class="form-inline">
                        	<div class="form-group">
                            	<label for="text">From Date:</label><input id="text" placeholder="dd-mm-yy" type="text" onkeyup="get_v_card_record_from_date(this.value)" class="form-control"/>
                            </div>
                            <div class="form-group">
                            	<label for="number">To Date:</label><input id="text" placeholder="dd-mm-yy" type="text" onkeyup="get_v_card_record_to_date(this.value)" class="form-control"/>
                            </div>
                        </form>
                        <div class="table-responsive">
                        	<table class="table table-bordered">
