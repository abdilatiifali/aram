      ...
      */
	  ...
	  // Show vehicle record after search....
	   if(isset($_REQUEST['search_vehicle_no']) && $_REQUEST['search_vehicle_no'] != '')
	   {
	      ...
	      unset($_SESSION['search_vt_statement']);
...
/*$(function() {
	...
	$( "#record_to_date" ).datepicker({
     ...
     <?php if(!isset($_GET['section'])) $_GET['section'] = 'vehicle'; ?>
        <div class="right-nav">
            <ul class="nav nav-tabs">
            	<li <?php if(isset($_GET['section']) && $_GET['section'] == 'vehicle') { ?>class="active" <?php } ?>><a  href="vehicle_transfer.php?section=vehicle">Vehicle</a></li>
                <li <?php if(isset($_GET['section']) && $_GET['section'] == 'search_vehicle') { ?> class="active" <?php } ?>><a data-toggle="tab" href="#search-vehicle">Search Vehicle</a></li>
                <li <?php if(isset($_GET['section']) && $_GET['section'] == 'card_list') { ?> class="active" <?php } ?>><a data-toggle="tab" href="#card-list3">Card List</a></li>
         ...
         <div id="vehicle-transfer" class="tab-pane fade in  <?php if(isset($_GET['section']) && $_GET['section'] == 'vehicle' ) echo 'active'; else echo 'fade'; ?>">
            <?php //if(isset($user_privileges[2]) && $user_privileges[2]['r'] == 1)
			{ ?>
            	<form role="form" class="form-inline" method="post" action="vehicle_transfer.php?section=vehicle">
               ...
               <form role="form" class="form-inline mar1">
                    	...
                    	<div class="col">
                        	<form role="form" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="text-middle" type="text" class="form-control" value="<?php echo isset($search_result->birth_place) ? $search_result->birth_place : '' ;?>"/>
                                </div>
                                <div class="form-group">
                ...
                <div class="stack">
					...
					-->						
                                            ...
                                            <div class="col4">
                                                <a href="vehicle_transfer.php?search_vehicle_no=<?php echo isset($search_result->plate_no) ? $search_result->plate_no : '';?>" class="btn btn-lg btn-default"><span style="color:black" class="fa fa-print"> Print</span></a>
                                            	<?php if(isset($user_privileges[6]) && ($user_privileges[6]['w'] == 1 && $user_privileges[6]['e'] == 1 )){ ?>
                                                	<a href="#" class="btn btn-lg btn-default pop"><span style="color:black" class="fa fa-exchange"> Transfer</span></a>
                                                <?php } ?>    
                                            </div>
                                            </div>
                                            </form>
                                    ...
                                    <table class="table table-bordered">
                                       ...
                                       <tbody id="vechicle_t_records_area">
                                        ...
                                        <?php // onclick="PrintVehicle('#tab')"
                                         ...
                                         {
                                        ?>
                                              <tr><td colspan="8" align="center"><span style="color:#F00;"> No record found</span></td></tr>
                                        <?php
                                          }
                                        ?>
                                       </tbody>
                                    ...
                                    <div class="popup">
                                        ...
                                        <div class="form-inline">
                                           ...
                                           <div class="form-group short-label">
                                                ...
                                                <input id="text-short" type="text" name="date" readonly class="form-control licence_receipt_issueDate" value="<?php echo isset($search_result->issue_date) ? $search_result->issue_date : '';?>"/>
                                            </div>
                                        </div>
                                        <div class="stack">
                                            <div class="row">
          ...
          <div id="search-vehicle" class="tab-pane <?php if(isset($_GET['section']) && $_GET['section'] == 'search_vehicle') echo 'active'; else echo 'fade'; ?>">
                    <?php if(isset($user_privileges[2]) && $user_privileges[2]['r'] == 1){ ?>
                    <div class="search-border">Search by</div>
                    <form role="form" class="form-inline">
                        <div class="form-group">
                            <label for="text">Number:</label>
                            <input id="text" type="text" onkeyup="get_vt_record_by_number(this.value)" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label for="number">Name:</label>
                            <input id="text" type="text" onkeyup="get_vt_record_by_name(this.value)" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label for="number">V.Type:</label>
                            <input id="text" type="text" onkeyup="get_vt_record_by_vt_type(this.value)" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label for="number">Contact:</label>
                            <input id="text" type="text" onkeyup="get_vt_record_by_vt_contact(this.value)" class="form-control"/>
                        </div>
                    </form>
                    <div class="table-responsive">
                        <table class="table table-bordered">
                           ...
                           <tbody id="vechicle_records_area">
                            <?php
                             ...
                             $per_page = 10; // Set how many records do you want to display per page.
                             $startpoint = ($page * $per_page) - $per_page;
							 $statement_for_pagination = ' tbl_vehicle_transfer   ';
                             ...
                             $data = mysqli_query($con,"{$statement} ORDER BY vt.id DESC LIMIT {$startpoint} , {$per_page}");
                             //echo "{$statement} ORDER BY vt.id DESC LIMIT {$startpoint} , {$per_page}";
                             //$data = mysqli_query($con, $sql);
                             while($rec = mysqli_fetch_object($data))
                             {   //acc_no  acc_name date acc_type amount comments
                                  /*
                              ...
                              */
                            ?>   <tr>
                                    <td><?php echo isset($rec->plate_no) ? $rec->plate_no : '';?></td>
                                    <td><?php echo isset($rec->Owner) ? $rec->Owner : '';?></td>
                                    <td><?php echo isset($rec->nationality) ? $rec->nationality : '';?></td>
                                    <td><?php echo isset($rec->issue_place) ? $rec->issue_place :'';?></td>
                                    <!--<td><?php  echo isset($rec->expire_date) ? date('d/m/Y', strtotime($rec->expire_date)) : '';?></td>-->
                                    <td><?php echo isset($rec->model) ? $rec->model : '';?></td>
                                    <td><?php echo isset($rec->color) ? $rec->color : '';?></td>
                                    <td><?php echo isset($rec->chassis_no) ? $rec->chassis_no : '';?></td>
                                    <td><?php echo isset($rec->engine_no) ? $rec->engine_no : '';?></td>
                                    <td><a href="?section=search_vehicle&search_vehicle_no=<?php echo isset($rec->plate_no) ? $rec->plate_no : ''; ?>" class="fa fa-print"></a></td>
                                 </tr>
                            <?php // onclick="PrintVehicle('#tab')"
                             }
							 if(mysqli_num_rows($data) == 0)
                    ...
                    <?php
                     ...
                     $pagination_data = array('current_statement' => $statement,
                                              ...
                                              'current_page' => $page,
                                              'db_con' => $con,
											  'statement_for_pagination' => $statement_for_pagination
                                              );
					 $_SESSION['pagination_vt__data'] = $pagination_data;
                    echo ajax_pagination($statement_for_pagination,$per_page,$page,$url='vehicles_transfer_pagination', $con);
                    ?>
                    </div>
                    <?php } ?>
										<hr/>
          ...
          <!-- END Search vehicle transfer -->
                ...
                <div id="card-list3" class="tab-pane <?php if(isset($_GET['section']) && $_GET['section'] == 'card_list') echo 'active'; else echo 'fade'; ?>">
                	<div class="search-border2">Search by date</div>
                        ...
                        <div class="table-responsive">
                        	<table class="table table-bordered">
                                ...
                                <tbody id="vechicle_card_list_records_area">
								...
								?>
									 <tr>
										...
										<td><?php echo $rec->chassis_no;?></td>
										<td><a href="?section=card_list&search_vehicle_no=<?php echo $rec->plate_no; ?>" class="fa fa-print"></a></td>
									 </tr>
								<?php // onclick="PrintVehicle('#tab')"
								 }
								 if(mysqli_num_rows($data) == 0)
                       ...
                       <style>
						...
						<div id="pagination_card_list_area_vehicle">
						<?php
						 // displaying paginaiton.
						 $pagination_data = array('current_statement' => $statement,
												  'per_page' => $per_page,
						 ...
						 $_SESSION['pagination_data_cl'] = $pagination_data;
						echo ajax_pagination($statement,$per_page,$page,$url='vehicles_transfer_cl_pagination', $con);
						?>
						</div>
          ...
          -->
                ...
                <h3> <center>Vehicle and transfer history </center></h3>
                ...
                <div style="padding-left:20px;">
                    ...
                    <table style="width:98%;text-align:left;" border="1" cellpadding="0" cellspacing="0">
                        ...
                        <tr >
                           ...
                           <td style="padding:5px;"><?php echo isset($search_result->passengers) ? $search_result->passengers : '';?></td>
                        </tr>
                     </table>
                </div>
                ...
                <div style="padding-left:20px;">
                    <table style="width:98%;border-top:1px solid #666;">
                       ...
                       <tbody id="">
                         <tr>
                                <td style="border-top:1px solid #666;" colspan="8"></td>
                            </tr>
                        <?php
						if(isset($_GET['search_vehicle_no']) && $_GET['search_vehicle_no'] != '')
					    {
							 $statement = "`tbl_vehicle_transfer` where plate_no = '".(isset($_REQUEST['search_vehicle_no']) ? $_REQUEST['search_vehicle_no'] : '')."' ORDER BY `id` DESC"; // Change `records` according to your table name.
							 $data = mysqli_query($con,"SELECT * FROM {$statement} ");
							 //echo "SELECT * FROM {$statement} <br/>";
							 while($rec = mysqli_fetch_object($data))
							 {          
                        ?>
                             <tr>
                       ...
                       <?php
						...
						?>
                              <tr>
                                <td style="color:red;" colspan="8" align="center">No record found</td>
                              </tr>
                         <?php
						}
						?>
