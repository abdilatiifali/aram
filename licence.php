    ...
    <div class="right-nav">
        ...
        <div class="tab-content">
                    ...
                    <form method="post" action="model/licence_model.php" enctype="multipart/form-data">                
                        ...
                        <div class="form-inline" style="margin: 0 0 20px;">
                            ...
                            <?php foreach($ArIssuePlace as $key => $value){
                                    if(isset($_SESSION['issue_place']) && $_SESSION['issue_place'] == $value)
                                            ...
                                            <?php $Countries = mysqli_query($con, 'select * from tbl_country'); ?>
                                                <select id="text-middle" size="1" name="nationality" required="required" >
                                                   ...
                                                   <?php while($row = @mysqli_fetch_object($Countries)) { ?>
                                                        <option value="<?php echo $row->name; ?>" <?php if($row->name == 'Somali') echo 'selected'; ?>><?php echo $row->name; ?></option>
                                                   <?php } ?>
                                                 </select>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="text" class="control-label2 col-sm-4">Blood Group:</label>
                                            <div class="col-sm-4">
												<select id="text-middle" size="1" name="blood_group">
            ...
            <div id="edit-renew" class="tab-pane <?php if(isset($_SESSION['licence_section']) && $_SESSION['licence_section'] == 'edit_licence') echo 'in active'; else echo 'fade'; ?>">
                    ...
                    <form method="post" action="model/licence_model.php" enctype="multipart/form-data">
                        <div class="form-inline" style="margin-bottom:20px;">
                            <div class="form-group">
                                ...
                                <?php foreach($ArIssuePlace as $key => $value){
                                        if(isset($check_data->issue_place))
                                        {
                            ...
                            <div class="form-group">
                                <label for="date">Receipt No:</label>
                                <input id="licence_edit_receipt_no" type="text" class="form-control text-short" name="receipt_no" value="<?php echo isset($check_data->receipt_no) ? $check_data->receipt_no : ''; ?>" required="required" />
                            </div>
                        </div>
                        <div class="stack">
                            <div class="row">
                                ...
                                <div class="col5">
                                    <div class="form-horizontal" style="margin-bottom:20px;">
                                        ...
                                        <div class="form-group" style="margin-bottom:10px;">
                                            ...
                                            <?php $Countries = mysqli_query($con, 'select * from tbl_country'); ?>
                                                <select id="text-middle" size="1" name="nationality" required="required" >
                                                   <option value="">Select Country</option>
                                                   <?php while($row = @mysqli_fetch_object($Countries)) { ?>
                                                        <option value="<?php echo $row->name; ?>" <?php if((isset($check_data->nationality) && $check_data->nationality == $row->name) || $row->name == 'Somali') echo 'selected'; ?>><?php echo $row->name; ?></option>
                                                   <?php } ?>
                                                 </select>
                                             </div>
                                        </div>
										<div class="form-group">
                                            <label for="text" class="control-label2 col-sm-4">Blood Group: </label>
                                            <div class="col-sm-4">
												<select id="text-middle" size="1" name="blood_group" required="required" >
													<option value="">Select Blood Group</option>
												    <option value="A-positive" <?php if($check_data->blood_group == 'A-positive') echo 'selected'; ?>>A+</option>
													<option value="A-negative" <?php if($check_data->blood_group == 'A-negative') echo 'selected'; ?>>A-</option>
													<option value="B-positive" <?php if($check_data->blood_group == 'B-positive') echo 'selected'; ?>>B+</option>
													<option value="B-negative" <?php if($check_data->blood_group == 'B-negative') echo 'selected'; ?>>B-</option>
													<option value="AB-positive" <?php if($check_data->blood_group == 'AB-positive') echo 'selected'; ?>>AB+</option>
													<option value="AB-negative" <?php if($check_data->blood_group == 'AB-negative') echo 'selected'; ?>>AB-</option>
													<option value="O-positive" <?php if($check_data->blood_group == 'O-positive') echo 'selected'; ?>>O+</option>
													<option value="O-negative" <?php if($check_data->blood_group == 'O-negative') echo 'selected'; ?>>O-</option>
												</select>
                                            </div>
                                        </div>
                                    </div>
					...
					<script>
                    var licence_edit_orignal_receipt_no = '<?php echo isset($check_data->receipt_no) ? $check_data->receipt_no : '';?>';
                    ...
                    {				
                        ...
                        if($("#licence_edit_receipt_no").val() == '')
                        { 
                             $('#show_error_msg').show().text('ERROR !  Please enter receipt number.');
                             return false;
                        }
                        if(licence_edit_orignal_receipt_no != $('#licence_edit_receipt_no').val())
                        {
                            get_receipt_data_licence_edit($('#licence_edit_receipt_no').val());
                            //alert(check_receipt);
                            //if(check_receipt)
                    ...
                    <div class="overlay">
                        <div class="popup">
                            ...
                            <tr class="success">
                                ...
                                <tr class="active">                       
                                   <form method="post" id="uploadForm" action="model/licence_renewal_model.php" >
                                    ...
                                    <td>
                                    <input id="licence_renew_hide_renewaldate" type="hidden" placeholder="dd-mm-yy" name="licence_renew_hide_renewaldate" required class="form-control insider licence_renew_hide_renewaldate" value="<?php echo isset($check_data->issue_date) ? date('d-m-Y', strtotime($check_data->issue_date)) : (isset($_SESSION['VEHISSDATE']) ? $_SESSION['VEHISSDATE'] : ''); ?>" />
                                                <input id="licence_renew_hide_expirydate" type="hidden" placeholder="dd-mm-yy" name="licence_renew_hide_expirydate" required class="form-control insider licence_renew_hide_expirydate" value="<?php echo isset($check_data->expiry_date) ? date('d-m-Y', strtotime($check_data->expiry_date)) : (isset($_SESSION['VEHEXPDATE']) ? $_SESSION['VEHEXPDATE'] : ''); ?>"/> 
                            ...
                            <option value="4">For Re-print</option>
                                        </select>
                                    </td>
                                    <td>       
            ...
            <input id="renewal_current_date" type="hidden" placeholder="dd-mm-yy" name="renewal_current_date" required class="form-control insider renewal_current_date" value="<?php echo date('d-m-Y');?>" />           
                                    ...
                                    <td><input id="expire_date4" type="text" placeholder="dd-mm-yy" name="expire_date" required class="form-control insider licence_renew_expire_date" value="<?php echo isset($_SESSION['VEHEXPDATE']) ? $_SESSION['VEHEXPDATE'] : '';?>" readonly="readonly"/>
                                    </td>
            ...
            <div id="search-licence" class="tab-pane <?php if(isset($_SESSION['licence_section']) && $_SESSION['licence_section'] == 'search_list') echo 'in active'; else echo 'fade'; ?>">
                <?php if(isset($user_privileges[5]) && ($user_privileges[5]['r'] == 1 )){ ?>
                    ...
                    <div class="form-group"><label for="number">Mother Name:</label><input id="text" type="text" onkeyup="get_l_record_by_mother(this.value);" class="form-control"/></div>
                    </form>
                    <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
            ...
            <div id="card-list" class="tab-pane <?php if(isset($_SESSION['licence_section']) && $_SESSION['licence_section'] == 'card_list') echo 'in active'; else echo 'fade'; ?>">
                    ...
                    <form role="form" class="form-inline">
                    <div class="form-group"><label for="text">From Date:</label><input id="by_from_date" type="text" onkeyup="get_l_record_by_from_date(this.value);" class="form-control" placeholder="dd-mm-yy"/></div>
                    ...
                    <div class="form-group"><label for="text">Licence No:</label><input id="by_licence_no" type="text" onkeyup="get_l_record_by_license_no(this.value);" class="form-control" placeholder="Licence No"/></div>
                    </form>
                    <?php
                    if(isset($_GET['cardId']))
                    {
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <thead>
                                ...
                                <tr class="active">
                                  <form method="post" action="model/licence_model.php<?php if(isset($_GET['cardId']) && $_GET['cardId'] !=''){ ?>?cardId=<?php echo $rec_id; ?><?php  } ?>">
                                    ...
                                    <?php foreach($ArIssuePlace as $key => $value){
                                        if(isset($card_data->issue_place) && $card_data->issue_place == $value)
                                            $sel	= "selected = 'selected' ";
                                        else
                                            $sel	=	"";	
                                        echo "<option value='$value' $sel>$value</option>";
                            ...
                            <tbody id="licence_card_record_area">
                             ...
                             $per_page = 10; // Set how many records do you want to display per page.
                             $startpoint = ($page * $per_page) - $per_page;
                             $statement_for_pagination = "SELECT d.* FROM tbl_driver_detail d 
                                            left join tbl_licence_renewal l_r
                                            on l_r.licence_no = d.licence_no
                                            WHERE 
                                                d.status = 1 
                                                and 
                                                (d.issue_date = curdate() OR (l_r.renewal_type > 0 and DATE(d.updated_At)  = curdate()))
                                            group by d.licence_no
                                            ORDER BY d.id desc ";
                             $data_pagination = mysqli_query($con," {$statement_for_pagination} ");
                             $statement = "SELECT d.* FROM tbl_driver_detail d 
                                            left join tbl_licence_renewal l_r
                                            on l_r.licence_no = d.licence_no
                                            WHERE 
                                                d.status = 1 
                                                ...
                                                (d.issue_date = curdate() OR (l_r.renewal_type > 0 and DATE(d.updated_At)  = curdate()))
                                            group by d.licence_no
                                            ORDER BY d.id desc ";   // Change `records` according to your table name.
                       ...
                       <div id="licence_card_pagination_area">
                        <?php
                         ...
                         $pagination_data = array('current_statement' => $statement,
                                                  ...
                                                  'current_page' => $page,
                                                  'db_con' => $con,
                                                  'total_pagination_count' => mysqli_num_rows($data_pagination)
                                                  );
                                              
                         $_SESSION['licence_card_pagination_data'] = $pagination_data;
                         echo ajax_pagination_Card_list(mysqli_num_rows($data_pagination),$per_page,$page,$url='licence_card_pagination', $con);
                        ?>
                        </div>
                        ...
                        <tr align="left">
                           <th align="left" style="padding:5px; text-align:left;">Place of Issue:</th>
												...
												<tr align="left">
													 ...
													 <td align="left" style="padding:5px; text-align:left;" colspan="2"><?php echo isset($search_result->personal_id) ? $search_result->personal_id : '';?></td>
													<th align="left" style="padding:5px; text-align:left;">Blood Group:</th>
													 <td align="left" style="padding:5px; text-align:left;" colspan="2"><?php echo isset($search_result->blood_group) ? $search_result->blood_group : '';?></td>
												</tr>
							...
							if(mysqli_num_rows($renewal_history) > 0)
							{
								 while($renewal_rec = @mysqli_fetch_object($renewal_history))
								 {
									 if($renewal_rec->renewal_type == 1)
										 ...
										 $renewl_type = 'Lost';
									 else if($renewal_rec->renewal_type == 4)
										 $renewl_type = 'For Re-print';		 	 
									 else
										 $renewl_type;	 
						   ?>		
									<tr align="left">
...
<script>
    $(document).ready(function(e) {
		...
		?>
			  ...
			  var content = "$$$$§A:p §S:f §D:"+setting+" §F0:"+license_no+"  §F1: "+name+" §F2:"+nationality+" §F3:"+date_birth+" §F4:"+issue_place+" §F5:"+vehicle_types+" §F6:"+issue_date+" §F7:"+expiry_date+" §IPhotograph:http:%%10.1.1.2%PRA%uploads%users_licence%"+image+"$$$$";
			 //var content = "$$$$/A:v /S:f /D:"+setting+" /F0:"+license_no+"  /F1:"+name+"/F2:"+nationality+"/F3:01-01-1990/F4:"+issue_place+" /F5:"+vehicle_types+" /F6:"+issue_date+" /F7:"+expiry_date+" /IPhotograph:http:%%10.1.1.2%PRA%uploads%users_licence%"+image+"$$$$";
			  		printDiv(content);
