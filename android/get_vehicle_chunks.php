...
$response = array();
  ...
  if($date=="")
  {
 $alldata= mysql_query("select id,Owner,nationality,mobile_no,gender,issue_date,expire_date,plate_no,plate_type,engine_no,v_type,color,chassis_no,model,comments,created_At from tbl_vehicles where id>$greater && id<$less"); 
