     ...
     <?php $user_privileges = $_SESSION['logged_in_user_privileges'];
      ...
      <div id="leftWrapper">
        <div id="listView" class="list">
          ...
          <?php } ?>
          <?php if(isset($user_privileges[5]) && ( $user_privileges[5]['r'] == 1 || $user_privileges[5]['w'] == 1 || $user_privileges[5]['e'] == 1)){ ?>
          ...
          <?php } ?>
          <?php if(isset($user_privileges[6]) && ( $user_privileges[6]['r'] == 1 || $user_privileges[6]['w'] == 1 || $user_privileges[6]['e'] == 1)){ ?>
          ...
          <?php } ?>
          <?php if(isset($user_privileges[7]) && ( $user_privileges[7]['r'] == 1 || $user_privileges[7]['w'] == 1 || $user_privileges[7]['e'] == 1)){ ?>
