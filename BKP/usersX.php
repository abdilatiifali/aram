...
<div class="right-nav">
	<ul class="nav nav-tabs">
    	<li <?php if(!isset($_SESSION['master_section']) ){ ?>class="active"<?php } ?>>
        	<a data-toggle="tab" href="#profile">User Profile</a>
        </li>
        <li <?php if(isset($_SESSION['master_section']) && $_SESSION['master_section'] == 'master' ){ ?>class="active"<?php } ?>><a data-toggle="tab" href="#user-master">Master</a></li>
    ...
    <div class="tab-content">
    	<div id="profile" class="tab-pane <?php if(!isset($_SESSION['master_section'])) echo 'in active'; else echo 'fade'; ?>">
            <?php
			   // Edit...
			   if(isset($_GET['id']))
			   {
        ...
        <div id="user-master" class="tab-pane <?php if(isset($_SESSION['master_section']) && $_SESSION['master_section'] == 'master') echo 'in active'; else echo 'fade'; ?>">
