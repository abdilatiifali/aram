...
else if(isset($_POST['receipt_no']) && isset($_POST['name']) && isset($_POST['licence_no']) && isset($_POST['issue_date']) && isset($_POST['birth_date']) )
{
	...
	{
	    $_SESSION['receipt_no']  =  mysqli_real_escape_string($con, $_POST['receipt_no']); 
		$_SESSION['fees'] =  mysqli_real_escape_string($con, $_POST['fees']);
		$_SESSION['name'] =  mysqli_real_escape_string($con, $_POST['name']);
		$_SESSION['licence_no'] =  mysqli_real_escape_string($con, $_POST['licence_no']);
		...
		$_SESSION['expiry_date'] =  mysqli_real_escape_string($con, $_POST['expiry_date']);
		...
		$_SESSION['contact_no'] =  mysqli_real_escape_string($con, $_POST['contact_no']);
		$_SESSION['personal_id'] =  mysqli_real_escape_string($con, $_POST['personal_id']);
		$_SESSION['vehicle_types'] =  mysqli_real_escape_string($con, $_POST['vehicle_types']);
		$_SESSION['comments'] =  mysqli_real_escape_string($con, $_POST['comments']);
		$_SESSION['file_name'] =  mysqli_real_escape_string($con, $_POST['file_name']);
