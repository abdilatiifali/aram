...
ini_set('max_execution_time', 600);
      ...
      */
	  ...
	  // Get V-Type records
	  if(!isset($_SESSION['V_type_data_session']))
	  {
		  $V_type_data = array();
		  ...
		  $_SESSION['V_type_data_session'] = $V_type_data;
	  }
	  else
...
?>
      ...
      <div class="right-nav">
        ...
        <div class="tab-content">
        	<?php if((isset($user_privileges[2]) && $user_privileges[2]['r'] == 1) && (!isset($_GET['section']))){ ?>
                                        ...
                                        <select id="text-middle" size="1" name="nationality" required>
                                           ...
                                           <?php //while($row = @mysqli_fetch_object($Countries)) { 
										   	foreach($countries_data as $row) { 
												if(isset($_SESSION['nationality']) && $row->name == $_SESSION['nationality'])
													$sel = "selected";
												else
													$sel = "";
										   ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php //$V_type = mysqli_query($con, 'select * from tbl_vehicle_types'); ?>
                                     <select id="text-short" size="1"  name="v_type" required>
                                       <option value="">Select V Type</option>
                                       <?php //while($row = @mysqli_fetch_object($V_type)) { ?>
                                       <?php foreach($V_type_data as $row){ ?>
