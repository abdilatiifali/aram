...
?>
              ...
              <form method="post" action="model/vehicles_model.php" >
               ...
               <div class="form-inline mar1">
               	   <div class="form-group">
                        ...
                        <input id="text-short" type="text" name="fees" readonly="readonly"  class="form-control licence_receipt_fee" value="<?=$_SESSION['fees']?>" required/>
                   </div>
                   <div class="form-group">
                   		<label for="date" class="control-label2 col-sm-4">Issue Date:</label>
                        <input id="" type="text" name="issue_date" readonly="readonly" class="form-control licence_receipt_issueDate "  value="<?=$_SESSION['issue_date']?>" required />
                   </div>
                   <div class="form-group">
                   		<label for="date" class="control-label2 col-sm-4">Expire Date:</label>
                        <input id="" type="text" name="expire_date" class="form-control expire_date"  value="<?=$_SESSION['expire_date']?>" required/>
                   </div>
                   <div class="form-group">
                   		<label for="date" class="control-label2 col-sm-4">Owner:</label>
                        <input id="text-long" type="text" name="owner" class="form-control licence_receipt_holder_name"  value="<?=$_SESSION['owner']?>" required/>
                   </div>
                </div>
                    	...
                    	<div class="col">
                        	<div class="form-horizontal">
                            	<div class="form-group">
                                    ...
                                    <input id="birth_date" type="text" name="birth_date" value="<?=$_SESSION['birth_date']?>" class="form-control text-middle" onkeypress="DateFormat(this,event.keyCode)" placeholder="dd-mm-yyyy" required />
                                </div>
                                <div class="form-group">
                                	<label for="text" class="control-label2 col-sm-4">Birth Place:</label>
                                    <input id="text-middle" type="text" name="birth_place" class="form-control" value="<?=$_SESSION['birth_place']?>" required />
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col2">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="text-middle" type="text" name="mother_name" class="form-control" value="<?=$_SESSION['mother_name']?>"  required/>
                                </div>
                                <div class="form-group">
                                    <label for="date" class="control-label2 col-sm-4">Personal ID:</label>
                                    <input id="text-middle" type="text" name="personal_id" class="form-control" value="<?=$_SESSION['personal_id']?>" required />
                                </div>
                            </div>
                        </div>
                        <div class="col3">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <input id="text-middle" type="text" name="mobile_no" class="form-control inch" value="<?=$_SESSION['mobile_no']?>" required />
                                </div>
                                <div class="form-group">
                                    <label for="date" class="control-label2 col-sm-4">Address:</label>
                                    <input id="text-middle" type="text" name="address" class="form-control inch" value="<?=$_SESSION['address']?>"  required/>
                                </div>
                                <div class="form-group">
                                    <label for="text" class="control-label2 col-sm-4">Email:</label>
                                    <input id="text-middle" type="text" name="email" class="form-control inch" value="<?=$_SESSION['email']?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-inline mar1">
                    ...
                    <div class="form-group onemargin">
                        ...
                        <input name="plate_no" type="text" class="form-control plate_no" style="width: 200px;" id="plate_no"  value="<?=$_SESSION['plate_no']?>" maxlength="4" required />
                ...
                <div class="stack">
                    <div class="row">
                        <div class="col-s">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="text-short" type="text" name="model" class="form-control" value="<?=$_SESSION['model']?>" required />
                                </div>
                            </div>
                         </div>
                        <div class="col-s">
                        ...
                        <input id="text-short" type="text" name="color" class="form-control" value="<?=$_SESSION['color']?>" required />
                        </div>
                        <div class="form-group">
                        <label for="date" class="control-label2 col-sm-4">Cylinder:</label>
                        <input id="text-short" type="text" name="cylinder" class="form-control" value="<?=$_SESSION['cylinder']?>" required />
                        </div>                        
                        </div>
                        </div>
                        <div class="col-s2">
                        ...
                        <input id="text-short" type="text" name="weight" class="form-control" value="<?=$_SESSION['weight']?>" />
                        </div>
                        </div>
                        </div>
                        <div class="col-s last2">
                        ...
                        <input id="text-short" type="text" name="hp" class="form-control" value="<?=$_SESSION['hp']?>" />
                        </div>
                        </div>
                        </div>
                        <div class="col-s last2">
                        ...
                        <input id="text-short" type="text" name="passengers" class="form-control" value="<?=$_SESSION['passengers']?>" required  />
                        </div>
                        </div>
                        </div>
                        </div>
                        ...
                        <input id="text-short" style="width:175px;" name="engine_no" type="text" class="22long form-control inch" value="<?=$_SESSION['engine_no']?>" required />
                        </div>
                        <div class="form-group">
                        <label for="text" class="control-label2 col-sm-4">Chassis No:    </label>
                        <input id="text-short" style="width:175px;" type="text" required="required" name="chassis_no" class="22long form-control inch" value="<?=$_SESSION['chassis_no']?>"  onblur="this.value=this.value.toUpperCase();" /><!-- onblur="this.value=this.value.toUpperCase();"-->
                        </div>
                        </div>
                        </div>
                        </div>
                ...
                <div class="col-sm-4">
                <input id="text-long" type="text" class="form-control" name="comments" value="<?=$_SESSION['comments']?>" />
                </div>
                <div class="col4">
           ...
           <div id="edit-renew2" class="tab-pane <?php if(isset($_GET['section']) && $_GET['section'] == 'edit_renew') echo 'active'; else echo 'fade'; ?>">
              ...
              <script>		
					...
					{ 
						...
						//alert(someDate);
						var numberOfDaysToAdd = <?=ONEYEAR?>; // 2 year 730;//
                 	...
                 	<table class="table table-bordered">
                        ...
                        <tbody id="vechicle_card_records_area">
                         ...
                         <?php
                             ...
                             $per_page = 10; // Set how many records do you want to display per page.
                             $startpoint = ($page * $per_page) - $per_page;
                             $statement = "`tbl_vehicles` WHERE status = 1 and updated_time > DATE_SUB(NOW(), INTERVAL 7 day) ORDER BY updated_time DESC"; // Change `records` according to your table name.
                             $data = mysqli_query($con,"SELECT * FROM {$statement} LIMIT {$startpoint} , {$per_page}");
                             //$sql = 'SELECT * from tbl_acc_type';
                             //$data = mysqli_query($con, $sql);
                             while($rec = mysqli_fetch_object($data))
      ...
      <table style="width:98%;text-align:left;" border="1" cellpadding="0" cellspacing="0">
                        ...
                        <tr align="left">
                           <th align="left" style="padding:5px;text-align:left;">T.Labixiyay:</th>
