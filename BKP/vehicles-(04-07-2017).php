                        ...
                        <div class="col-s">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $V_type = mysqli_query($con, 'select * from tbl_vehicle_types order by vehicle_type ASC'); ?>
           ...
           <div id="edit-renew2" class="tab-pane <?php if(isset($_GET['section']) && $_GET['section'] == 'edit_renew') echo 'active'; else echo 'fade'; ?>">
               ...
               <div class="form-inline mar1">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $Countries = mysqli_query($con, 'select * from tbl_country order by name'); ?>
                                        <select id="text-middle" size="1" name="nationality" required>
                                           <option value="">Select Country</option>
                                           <?php while($row = @mysqli_fetch_object($Countries)) { ?>
                                                <option value="<?php echo $row->name; ?>" <?php if((isset($search_result->nationality) && $search_result->nationality == $row->name) || $row->name == 'Somali') echo 'selected'; ?>><?php echo $row->name; ?></option>
                                           <?php } ?>
                                         </select>
                ...
                <div class="stack">
                    <div class="row">
                        ...
                        <input id="text-short" type="text" name="passengers" class="form-control" value="<?php echo isset($search_result->passengers) ? $search_result->passengers : '';?>"  required />
                            ...
                            <input id="text-short" style="width:175px;" type="hidden" name="hchassis_no" class="22long form-control inch" value="<?php echo isset($search_result->chassis_no) ? $search_result->chassis_no : '';?>"/><!-- onblur="this.value=this.value.toUpperCase();"-->
                            </div>
                            </div>
                            </div>
                            </div>
                ...
                <div class="overlay">
					...
					<option value="4">For Duplicate</option>
                                        <!-- <option value="5">For Transfer</option> -->
                                    </select>
                                        </td>
                                        <td>
              ...
              <table style="width:98%;border-top:1px solid #666;">
                        ...
                        <tr>
							...
							if($row->renewal_type == 1)
								...
								echo   $renewal_type = 'For Duplicate';
