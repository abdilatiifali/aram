...
ini_set('max_execution_time', 600);
      ...
      */
	  ...
	  // Show vehicle record after search....
	   ...
	   {
			$data = mysqli_query($con,"SELECT * FROM tbl_vehicles where id = '".base64_decode(mysqli_real_escape_string($con, $_REQUEST['cardlist_id']))."' ");
...
?>
      ...
      <div class="right-nav">
        <ul class="nav nav-tabs">
            ...
            <li <?php if(isset($_GET['section']) && $_GET['section'] == 'card_list') { ?> class="active" <?php } ?>><a data-toggle="tab" href="#card-list2">Card List</a></li>
              ...
              <form method="post" action="model/vehicles_model.php" >
            	<div class="form-inline" >
                	<div class="form-group">
                        ...
                        <input id="receipt_no" type="text" name="search_receipt_no" required="required" placeholder="Receipt No" class="form-control" value="<?php echo isset($_POST['search_vehicle_no']) ? $_POST['search_vehicle_no'] : $_SESSION['receipt_no'] ;?>" onblur="Search_receipt_data()" />
               ...
               <div class="form-inline mar1">
               	   <div class="form-group">
                        ...
                        <option value="<?php echo $ArIssuePlace[0]?>" <?php if($_SESSION['issue_place'] == $ArIssuePlace[0]) echo 'selected'; ?>><?php echo $ArIssuePlace[0]?></option>
                         </select>
               ...
               <div class="form-inline mar1">
               	   <div class="form-group">
                        ...
                        <input id="text-short" type="text" name="fees" readonly="readonly"  class="form-control licence_receipt_fee" value="<?php echo $_SESSION['fees']; ?>" required/>
                   </div>
                   <div class="form-group">
                   		<label for="date" class="control-label2 col-sm-4">Issue Date:</label>
                        <input id="" type="text" name="issue_date" readonly="readonly" class="form-control licence_receipt_issueDate "  value="<?php echo $_SESSION['issue_date'];?>" required />
                   </div>
                   <div class="form-group">
                   		<label for="date" class="control-label2 col-sm-4">Expire Date:</label>
                        <input id="" type="text" name="expire_date" class="form-control expire_date"  value="<?php echo $_SESSION['expire_date'];?>" required/>
                   </div>
                   <div class="form-group">
                   		<label for="date" class="control-label2 col-sm-4">Owner:</label>
                        <input id="text-long" type="text" name="owner" class="form-control licence_receipt_holder_name"  value="<?php echo $_SESSION['owner'];?>" required/>
                   </div>
                </div>
                    	...
                    	<div class="col">
                        	<div class="form-horizontal">
                            	<div class="form-group">
                                    ...
                                    <input id="birth_date" type="text" name="birth_date" value="<?php echo $_SESSION['birth_date'];?>" class="form-control text-middle" onkeypress="DateFormat(this,event.keyCode)" placeholder="dd-mm-yyyy" required />
                                </div>
                                <div class="form-group">
                                	<label for="text" class="control-label2 col-sm-4">Birth Place:</label>
                                    <input id="text-middle" type="text" name="birth_place" class="form-control" value="<?php echo $_SESSION['birth_place'];?>" required />
                                </div>
                                <div class="form-group">
                                	<label for="text" class="control-label2 col-sm-4">Gender:</label>
                                    <select id="text-middle" size="1" name="gender" required>
                                        <option value="Lab" <?php echo($_SESSION['gender']=='Lab')?"selected":""; ?>>Lab</option>
                                        <option value="Dhedig" <?php echo($_SESSION['gender']=='Dhedig')?"selected":""; ?>>Dhedig</option>
                                    </select>
                        ...
                        <div class="col2">
                            <div class="form-horizontal">
                                    ...
                                    <?php $Countries = mysqli_query($con, 'select * from tbl_country order by name'); ?>
                                        <select id="text-middle" size="1" name="nationality" required>
                                           ...
                                           <?php while($row = @mysqli_fetch_object($Countries)) { 
											...
											if($row->name == $_SESSION['nationality'])
												$sel = "selected";
											else
												$sel = "";
										   ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="text-middle" type="text" name="mother_name" class="form-control" value="<?php echo $_SESSION['mother_name'];?>"  required/>
                                </div>
                                <div class="form-group">
                                    <label for="date" class="control-label2 col-sm-4">Personal ID:</label>
                                    <input id="text-middle" type="text" name="personal_id" class="form-control" value="<?php echo $_SESSION['personal_id'];?>" required />
                                </div>
                            </div>
                        </div>
                        <div class="col3">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <input id="text-middle" type="text" name="mobile_no" class="form-control inch" value="<?php echo $_SESSION['mobile_no'];?>" required />
                                </div>
                                <div class="form-group">
                                    <label for="date" class="control-label2 col-sm-4">Address:</label>
                                    <input id="text-middle" type="text" name="address" class="form-control inch" value="<?php echo $_SESSION['address'];?>"  required/>
                                </div>
                                <div class="form-group">
                                    <label for="text" class="control-label2 col-sm-4">Email:</label>
                                    <input id="text-middle" type="text" name="email" class="form-control inch" value="<?php echo $_SESSION['email'];?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-inline mar1">
                    <div class="form-group onemargin2">
                        ...
                        <select id="text-middle" size="1" name="plate_type" required>
                           ...
                           <?php while($row = @mysqli_fetch_object($Plate_types)) { 
						   	if($row->plate_type == $_SESSION['plate_type'])
								$sel = "selected";
							else
								$sel = "";
						   ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="text-middle" size="1" name="code" onchange="get_veh_new_plate_number(this.value)" required>
                           ...
                           <? 					   
								if($row->vehicle_plate_code == $_SESSION['code'])
									$sel = "selected";
								else
									$sel = "";
						   ?>
                    ...
                    <div class="form-group onemargin">
                        ...
                        <input name="plate_no" type="text" class="form-control plate_no" style="width: 200px;" id="plate_no"  value="<?php echo $_SESSION['plate_no'];?>" maxlength="4" required />
                ...
                <div class="stack">
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <select id="text-short" size="1"  name="vehicle" required>
                                       <option value="Gaari" <?php echo($_SESSION['vehicle']=='Gaari')?"selected":""; ?>>Gaari</option>
                                       <option value="Mooto" <?php echo($_SESSION['vehicle']=='Mooto')?"selected":""; ?>>Mooto</option>
                                       <option value="Bajaj" <?php echo($_SESSION['vehicle']=='Bajaj')?"selected":""; ?>>Bajaj</option>
                                       <option value="isjeed" <?php echo($_SESSION['vehicle']=='isjeed')?"selected":""; ?>>isjeed</option>
                                       <option value="Cagaf" <?php echo($_SESSION['vehicle']=='Cagaf')?"selected":""; ?>>Cagaf</option>
                                       <option value="rimoor" <?php echo($_SESSION['vehicle']=='rimoor')?"selected":""; ?>>rimoor</option>
                                       <option value="kreen" <?php echo($_SESSION['vehicle']=='kreen')?"selected":""; ?>>kreen</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="text" class="control-label2 col-sm-4">V.Type:</label>
                                    <?php $V_type = mysqli_query($con, 'select * from tbl_vehicle_types'); ?>
                                     <select id="text-short" size="1"  name="v_type">
                                       <option value="">Select V Type</option>
                                       <?php while($row = @mysqli_fetch_object($V_type)) {
									    
									   if($row->vehicle_type == $_SESSION['v_type'])
											$sel = "selected";
										else
											$sel = "";
									   ?>
                                            <option value="<?php echo $row->vehicle_type; ?>" <?php echo $sel?>><?php echo $row->vehicle_type; ?></option>
                                       <?php } ?>
                                     </select>
                                </div>
                                <div class="form-group">
                                    <label for="text" class="control-label2 col-sm-4">Model:</label>
                                    <input id="text-short" type="text" name="model" class="form-control" value="<?php echo $_SESSION['model'];?>" required />
                                </div>
                            </div>
                         </div>
                        <div class="col-s">
                        ...
                        <input id="text-short" type="text" name="color" class="form-control" value="<?php echo $_SESSION['color'];?>" required />
                        </div>
                        <div class="form-group">
                        <label for="date" class="control-label2 col-sm-4">Cylinder:</label>
                        <input id="text-short" type="text" name="cylinder" class="form-control" value="<?php echo $_SESSION['cylinder'];?>" required />
                        </div>                        
                        </div>
                        </div>
                        <div class="col-s2">
                        ...
                        <input id="text-short" type="text" name="weight" class="form-control" value="<?php echo $_SESSION['weight'];?>" />
                        </div>
                        </div>
                        </div>
                        <div class="col-s last2">
                        ...
                        <input id="text-short" type="text" name="hp" class="form-control" value="<?php echo $_SESSION['hp'];?>" />
                        </div>
                        </div>
                        </div>
                        <div class="col-s last2">
                        ...
                        <input id="text-short" type="text" name="passengers" class="form-control" value="<?php echo $_SESSION['passengers'];?>" required  />
                        </div>
                        </div>
                        </div>
                        </div>
                        ...
                        <input id="text-short" style="width:175px;" name="engine_no" type="text" class="22long form-control inch" value="<?php echo $_SESSION['engine_no'];?>" required />
                        </div>
                        <div class="form-group">
                        <label for="text" class="control-label2 col-sm-4">Chassis No:    </label>
                        <input id="text-short" style="width:175px;" type="text" required="required" name="chassis_no" class="22long form-control inch" value="<?php echo $_SESSION['chassis_no'];?>"  onblur="this.value=this.value.toUpperCase();" /><!-- onblur="this.value=this.value.toUpperCase();"-->
                        </div>
                        </div>
                        </div>
                        </div>
                ...
                <div class="col-sm-4">
                <input id="text-long" type="text" class="form-control" name="comments" value="<?php echo $_SESSION['comments'];?>" />
                </div>
                <div class="col4">
               ...
               <div class="form-inline mar1">
                ...
                <div class="form-inline mar1">
                    ...
                    <div class="form-group onemargin" style="margin-left:12px;">
                        <label for="date" class="control-label2 col-sm-4">Plate No:</label>
                        <?php $plate_no = filter_var($search_result->plate_no, FILTER_SANITIZE_NUMBER_INT);?>
                ...
                <div class="stack">
                    <div class="row">
                        <div class="col-s">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="text" class="control-label2 col-sm-4">V.Type:</label>
                                    <?php $V_type = mysqli_query($con, 'select * from tbl_vehicle_types'); ?>
                                     <select id="text-short" size="1"  name="v_type" required>
                                       <option value="">Select V Type</option>
                                       <?php while($row = @mysqli_fetch_object($V_type)) { ?>
                                            <option value="<?php echo $row->vehicle_type; ?>" <?php if(isset($search_result->v_type) && $search_result->v_type == $row->vehicle_type) echo 'selected'; ?>><?php echo $row->vehicle_type; ?></option>
                                       <?php } ?>
                                     </select>
                                </div>
                                <div class="form-group">
                        ...
                        <input id="text-short" type="text" name="passengers" class="form-control" value="<?php echo isset($search_result->passengers) ? $search_result->passengers : '';?>"  required />
                            ...
                            <div class="form-group">
                            <label for="text" class="control-label2 col-sm-4">Chassis No:    </label>
                            <?php $chassno = strtoupper($search_result->chassis_no); ?>
                            	...
                            	<thead>
                                    ...
                                    <tr class="active">
                                      <form method="post" id="uploadForm" action="model/vehicle_renewal_model.php" >
                                        ...
                                        <td>
                                       <input id="licence_renew_hide_renewaldate" type="hidden" placeholder="dd-mm-yy" name="licence_renew_hide_renewaldate" required class="form-control insider licence_renew_hide_renewaldate" value="<?php echo isset($search_result->issue_date) ? date('d-m-Y', strtotime($search_result->issue_date)) : $_SESSION['VEHISSDATE'];?>" />
                                        <input id="licence_renew_hide_expirydate" type="hidden" placeholder="dd-mm-yy" name="licence_renew_hide_expirydate" required class="form-control insider licence_renew_hide_expirydate" value="<?php echo isset($search_result->expiry_date) ? date('d-m-Y', strtotime($search_result->expiry_date)) : $_SESSION['VEHEXPDATE']; ?>"/> 
                                    ...
                                    <select id="renewal_type" class="text-short" size="1" style="padding:0" name="renewal_type" onchange="Change_vehicle_renewal_type(this.value)">
                                        ...
                                        <!-- <option value="4">For Transfer</option> -->
                                    </select>
                                        </td>
                                        <td>
                                        ...
                                        <td><a href="javascript:void(0);" onclick="submit_vehicle_renewal_form()" style="color: green" class="fa fa-save"></a>
                                            ...
                                            <input type="submit" value="submit" id="sub_btn_veh_renewal" style="display:none;"/>
                 	...
                 	<table class="table table-bordered">
                        ...
                        <tbody id="vechicle_card_records_area">
                         ...
                         <?php
                             ...
                             $per_page = 10; // Set how many records do you want to display per page.
                             $startpoint = ($page * $per_page) - $per_page;
                             $statement = "`tbl_vehicles` WHERE status = 1 and issue_date = curdate() ORDER BY updated_time DESC"; // Change `records` according to your table name.
                             $data = mysqli_query($con,"SELECT * FROM {$statement} LIMIT {$startpoint} , {$per_page}");
                             //$sql = 'SELECT * from tbl_acc_type';
                             //$data = mysqli_query($con, $sql);
                             while($rec = mysqli_fetch_object($data))
                            ...
                            ?>
                                 <tr>
                                    ...
                                    <td><?php echo $rec->chassis_no;?></td>
                                    <td>
                                    	<a href="?cardlist_id=<?php echo base64_encode($rec->id); ?>" class="glyphicon glyphicon-edit"></a>
            ...
            <div  id="tab" style="display:none;">
                ...
                <div style="padding-left:20px;">
                    ...
                    <table style="width:98%;text-align:left;" border="1" cellpadding="0" cellspacing="0">
                        ...
                        <tr align="left">
                           <th align="left" style="padding:5px;text-align:left;">Qofka:</th>
                           <td align="left" style="padding:5px;text-align:left;"><?php echo isset($search_result->gender) ? $search_result->gender : '';?></td>
                        </tr>
                        <tr align="left">
                           <th align="left" style="padding:5px;text-align:left;">Jinsiyada:</th>
                           <td align="left" style="padding:5px;text-align:left;"><?php echo isset($search_result->nationality) ? $search_result->nationality : '';?></td>
                        </tr>
                        <tr>
                        ...
                        <tr align="left">
                           <th  align="left" style="padding:5px;text-align:left;">Email-ka:</th>
                           <td align="left" style="padding:5px;text-align:left;" ><?php echo isset($search_result->email) ? $search_result->email : '';?></td>
                        </tr>
                        <tr align="left">
              ...
              <table style="width:98%;border-top:1px solid #666;">
                        ...
                        <tr>
							...
							if($row->renewal_type == 1)
								...
								echo   $renewal_type = 'For Transfer';
